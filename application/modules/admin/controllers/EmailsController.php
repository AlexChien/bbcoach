 ...
 * @desc emailing controller
 *
 * @author Pascal CESCATO
 * @copyright EuroRSCG
 */

class Admin_EmailsController extends Enterprise_Controller {
	...
	public function semaineAction() {
		...
		Zend_registry::set('week', $week);

		Zend_Debug::dump(new Admin_Model_Relance($this->_config->relance->firstMail, null));
	}
...
// echo var_dump($this->_config->relance);  exit;
		new Admin_Model_Relance($this->_config->relance->every, 'b');
	}
	...
	$queries[] = "INSERT INTO `user` (`id`, `registration`, `firstName`, `lastName`, `lang`, `realAge`, `height`, `weight`, `gender`, `pregnancy`, `breastFeeding`, `lifeStyle`, `waterDrank`, `waterFood`, `waterLost`, `waterIdeal`, `email`, `mailing`, `coaching`, `password`, `loginDirect`, `valid`) VALUES(1, '2010-03-01 15:05:40', 'Pierre', 'Durand', 'cn', 20, 2, 3, 4, 3, 5, 3, '1.0', '2.0', '1.0', '1.0', 'johnsonqu@gmail.com', 1, 1, '5f4dcc3b5aa765d61d8327deb882cf99', '356a192b7913b04c54574d18c28d46e6395428ab9da78baea3166eed5b30d84b6dbb2da26819ba37', 1)";
		$queries[] = "INSERT INTO `user` (`id`, `registration`, `firstName`, `lastName`, `lang`, `realAge`, `height`, `weight`, `gender`, `pregnancy`, `breastFeeding`, `lifeStyle`, `waterDrank`, `waterFood`, `waterLost`, `waterIdeal`, `email`, `mailing`, `coaching`, `password`, `loginDirect`, `valid`) VALUES(2, '2010-03-01 15:05:40', 'Louis', 'Dupond', 'fr', 18, 2, 3, 4, 3, 5, 2, '1.0', '2.0', '1.0', '1.0', 'ichbinzeus@hotmail.com', 1, 1, '5f4dcc3b5aa765d61d8327deb882cf99', 'da4b9237bacccdf19c0760cab7aec4a8359010b045fd327dbd5a98daab72be389edfe0bcdb529af6', 1)";
		$queries[] = "INSERT INTO `user` (`id`, `registration`, `firstName`, `lastName`, `lang`, `realAge`, `height`, `weight`, `gender`, `pregnancy`, `breastFeeding`, `lifeStyle`, `waterDrank`, `waterFood`, `waterLost`, `waterIdeal`, `email`, `mailing`, `coaching`, `password`, `loginDirect`, `valid`) VALUES(3, '2010-03-01 15:05:40', 'Lise', 'Lecourt', 'cn', 45, 2, 3, 4, 3, 5, 3, '1.0', '2.0', '1.0', '1.0', 'alex.chien@koocaa.com', 1, 1, '5f4dcc3b5aa765d61d8327deb882cf99', '77de68daecd823babbb58edb1c8e14d7106e83bb9f57265137d6512b85da5c2eb47ce8c9e31349f3', 1)";
		$queries[] = "INSERT INTO `user` (`id`, `registration`, `firstName`, `lastName`, `lang`, `realAge`, `height`, `weight`, `gender`, `pregnancy`, `breastFeeding`, `lifeStyle`, `waterDrank`, `waterFood`, `waterLost`, `waterIdeal`, `email`, `mailing`, `coaching`, `password`, `loginDirect`, `valid`) VALUES(4, '2010-03-01 15:05:40', 'Karl', 'Soum', 'us', 21, 2, 3, 4, 3, 5, 1, '1.0', '2.0', '1.0', '1.0', 'alex.chien@enjoyoung.cn', 1, 1, '5f4dcc3b5aa765d61d8327deb882cf99', '1b6453892473a467d07372d45eb05abc2031647a549714d927217716bcee59e53d543bf01579d64a', 1)";
		$queries[] = "INSERT INTO `user` (`id`, `registration`, `firstName`, `lastName`, `lang`, `realAge`, `height`, `weight`, `gender`, `pregnancy`, `breastFeeding`, `lifeStyle`, `waterDrank`, `waterFood`, `waterLost`, `waterIdeal`, `email`, `mailing`, `coaching`, `password`, `loginDirect`, `valid`) VALUES(5, '2010-03-01 15:05:40', 'Colin', 'Maillard', 'fr', 30, 2, 3, 4, 3, 5, 2, '1.0', '2.0', '1.0', '1.0', 'alexchien97@gmail.com', 1, 1, '5f4dcc3b5aa765d61d8327deb882cf99', 'c1dfd96eea8cc2b62785275bca38ac261256e2780a9cdf7b5195ff9be499d9df03e050c8c0003245', 1)";
		$queries[] = "INSERT INTO `user` (`id`, `registration`, `firstName`, `lastName`, `lang`, `realAge`, `height`, `weight`, `gender`, `pregnancy`, `breastFeeding`, `lifeStyle`, `waterDrank`, `waterFood`, `waterLost`, `waterIdeal`, `email`, `mailing`, `coaching`, `password`, `loginDirect`, `valid`) VALUES(6, '2010-03-01 15:05:40', 'Paul', 'Fon', 'us', 30, 2, 3, 4, 3, 5, 1, '1.0', '2.0', '1.0', '1.0', 'jingsong.qu@enjoyoung.cn', 1, 1, '5f4dcc3b5aa765d61d8327deb882cf99', '902ba3cda1883801594b6e1b452790cc53948fda30a80677c37c68e8d98923b68dc995591b8b808b', 1)";    
