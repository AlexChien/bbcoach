...
define('APPLICATION_PATH', 'D:/training/application');
define('EVIAN_PATH', 'D:/training');
// define('APPLICATION_PATH', $realpath . '/application');

set_include_path(implode(PATH_SEPARATOR, array(EVIAN_PATH . '/library', get_include_path())));
